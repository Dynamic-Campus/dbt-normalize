...
select
    ...
    cast({{ adapter.quote('Degree CIP 4') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('degree_cip_4') }},
    cast({{ adapter.quote('Degree CIP 2') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('degree_cip_2') }},
    cast({{ adapter.quote('Degree CIP 3') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('degree_cip_3') }},
    ...
    cast({{ adapter.quote('Degree CIP 1') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('degree_cip_1') }},
    ...
    cast({{ adapter.quote('Enrollment CIP 2') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('enrollment_cip_2') }},
    cast({{ adapter.quote('Enrollment CIP 1') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('enrollment_cip_1') }},
