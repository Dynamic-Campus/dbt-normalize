...
select
    ...
    cast({{ adapter.quote('Enrollment CIP 2') }} as {{ dbt_utils.type_float() }}) as {{ adapter.quote('enrollment_cip_2') }},
    cast({{ adapter.quote('Enrollment CIP 1') }} as {{ dbt_utils.type_float() }}) as {{ adapter.quote('enrollment_cip_1') }},
    ...
    cast({{ adapter.quote('Graduation Date') }} as {{ dbt_utils.type_float() }}) as {{ adapter.quote('graduation_date') }},
    ...
    cast({{ adapter.quote('College Sequence') }} as {{ dbt_utils.type_float() }}) as {{ adapter.quote('college_sequence') }},
